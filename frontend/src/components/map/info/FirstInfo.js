  ...
  return (
    <InfoPage>
      ...
      <TextInfo>
        ...
        investments. There is also a settings page where you can change your
        avatar, your password and color your spaceship.
      </TextInfo>
      <TextInfo>
        Next to your profile we have our Citizen Messageboard, where everyone
        can make a post.
      </TextInfo>
      <BottomText>

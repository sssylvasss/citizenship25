    ...
    <Main>
      <ProfileContainer>
        ...
        <DaysContainer>
          ...
          <DaysText>Days to destination: {timeToDestination}</DaysText>
        </DaysContainer>
        <Items>
          <ContainerTitle>
            My energy
          ...
          <EnergyProfile openEnergy={openEnergy} toggleEnergy={toggleEnergy} />
        </Items>
        <Items>
          <ContainerTitle>My items</ContainerTitle>
          {myItems.map((key) => (
            <ItemsProfile key={key} item={items[key]} />
          ))}
        </Items>
        <Investments>
          <ContainerTitle>
